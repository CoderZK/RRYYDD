...
- (void)setSubController{
    ...
    NSArray *VCNameArr = @[@"XBJinRRHomeViewController",@"XBJinRRLookLoanViewController",@"XBJinRR_LoadDistributionViewController",@"XBJinRR_NewsViewController",@"XBJinRRPersonalViewController"];//chb修改的
...
//        [WGTemporaryTool standardUserUtil].baseNav =VCNav;
    ...
    NSArray *tabBarTitleArr  = @[@"首页",@"借款",@"推广",@"资讯",@"我的"];
    NSArray *tabBarImgArr = @[@"home",@"loan",@"distribution",@"news",@"my"];
