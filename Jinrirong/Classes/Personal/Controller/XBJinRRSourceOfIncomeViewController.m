...
- (void) createSegmentedControl {
    ...
    self.recommendViewController.view.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
    [self addChildViewController:self.recommendViewController];
    
    self.vipViewController = [XBJinRRIncomeFromVipViewController new];
    self.vipViewController.view.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
