...
@interface kkkkAddHuiYiVC ()
@property (weak, nonatomic) IBOutlet UITextField *TF;
@property (weak, nonatomic) IBOutlet UITextView *TV;
@end

@implementation kkkkAddHuiYiVC
...
- (IBAction)add:(id)sender {
    ...
    NSString * sql = [NSString stringWithFormat:@"insert into kkkk_huiYi (title,content,status,userId) values ('%@','%@','%d','%@')",self.TF.text,self.TV.text,0,[UDefault getObject:@"phone"]];
