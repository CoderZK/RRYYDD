...
@interface kkkkAddRenWuVC ()
@property (weak, nonatomic) IBOutlet UITextField *TF;
@property (weak, nonatomic) IBOutlet UITextView *TV;
@end

@implementation kkkkAddRenWuVC
...
- (IBAction)add:(id)sender {
    ...
    NSString * sql = [NSString stringWithFormat:@"insert into kkkk_renWu (title,content,status,userId) values ('%@','%@','%d','%@')",self.TF.text,self.TV.text,0,[UDefault getObject:@"phone"]];
