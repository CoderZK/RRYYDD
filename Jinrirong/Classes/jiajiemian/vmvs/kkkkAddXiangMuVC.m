...
- (IBAction)add:(id)sender {
    ...
    NSString * sql = [NSString stringWithFormat:@"insert into kkkk_renWu (title,content,status,userId,names) values ('%@','%@','%d','%@','%@')",self.TF.text,self.TV.text,0,[UDefault getObject:@"phone"],self.namesTV.text];
