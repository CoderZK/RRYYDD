...
#import "kkkkAddRiBaoVC.h"
@interface kkkkRiBaoListVC ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@property(nonatomic,strong)NSMutableArray *dataArray;
@end

@implementation kkkkRiBaoListVC
...
- (void)viewDidLoad {
    ...
    [button setTitle:@"添加日报" forState:UIControlStateNormal];
...
- (void)add {
    kkkkAddRiBaoVC * vc =[[kkkkAddRiBaoVC alloc] init];
...
- (void)getData {
    ...
    NSString * sql = [NSString stringWithFormat:@"select *from kkkk_riBao where userId='%@'",[UDefault getObject:@"phone"]];
    if (isOpen) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLB.text = [NSString stringWithFormat:@"日报题目: %@",model.title];
    cell.contentLB.text = [NSString stringWithFormat:@"日报内容: %@",model.content];
    return cell;
