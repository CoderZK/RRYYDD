...
static FYSignleTool * tool = nil;


@implementation FYSignleTool

+ (FYSignleTool *)shareTool {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        tool = [[FYSignleTool alloc] init];
    });
    return tool;
}
...
//        NSDictionary * dic = @{
//                               @"token":deviceToken,
//                               @"userId":[FYSignleTool shareTool].userInfoModel.ID,
//                               @"type":@"1"
//                               };
//        [FYRequestTool networkingPOST:[FYURL getsaveUPushTokenURL] parameters:dic success:^(NSURLSessionDataTask *task, id responseObject) {
//            
//            NSLog(@"上传友盟推送成功\n%@",responseObject);
//            
